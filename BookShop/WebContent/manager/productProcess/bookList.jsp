	...
	<table class="table">
		<tr>
			...
			<td>
				<!-- 도서종류를 선택하는 메뉴 -->
				<div class="btn-group">
					<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-expanded="false">도서종류<span class="caret"></span></button>
...
<table class="table table-bordered table-striped nanum table-hover">
	...
	<tr height="30">
		...
		<td width="50" align="center">
			<a href="bookUpdateForm.jsp?book_id=<%=book.getBook_id()%>&book_kind_=<%=book.getBook_kind()%>">수정</a>
			</td>
		<td width="50" align="center">
			<a href="bookDeleteForm.jsp?book_id=<%=book.getBook_id()%>&book_kind_=<%=book.getBook_kind()%>">삭제</a>
			</td>
	</tr>
	<%
	}
