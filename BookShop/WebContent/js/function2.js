...
function memberInsertCheckForm(memInsForm) {
	...
	if(memInsForm.tel3.value.length < 4) {
		alert("전화번호 3번째 자리는 최소 4자를 입력하셔야 합니다.");
		memInsForm.tel3.focus();
		return false;
	}
